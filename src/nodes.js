// Sections
const verMasBtn = document.querySelector(".trendingPreview-btn");
...
const likedList = document.querySelector('.liked-movieList');
...
const bodyRelative = document.querySelector('body');
